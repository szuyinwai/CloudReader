package com.example.jingbin.cloudreader.utils.helper;

import android.content.Context;

import com.example.jingbin.cloudreader.utils.Constants;
...
public class PaymentsHelper {
    ...
    public static JSONObject getPaymentDataRequest(long priceCents) {
        ...
        final String price = PaymentsHelper.centsToString(priceCents);

        try {
            JSONObject paymentDataRequest = PaymentsHelper.getBaseRequest();
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(PaymentsHelper.getCardPaymentMethod()));
            paymentDataRequest.put("transactionInfo", PaymentsHelper.getTransactionInfo(price));
            paymentDataRequest.put("merchantInfo", PaymentsHelper.getMerchantInfo());
    ...
    /**
     * Converts cents to a string format accepted by {@link PaymentsHelper#getPaymentDataRequest}.
     *
